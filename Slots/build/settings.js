...
PiecSettings.fontFamily = "BeachBarScriptHeavy"; //Make sure that this font is on the css and that there is a div that uses it. (preload-font div)
...
PiecSettings.reels = [ // Tease on first spin, win on second, big win on third
    ...
    ["T","T","T","L","B","J","J","J","B","T","T","T","T","R","B","B","P","R","N","B","J","N","J","Q","J","L","T","N","P","N","R","T","J","J","J","A","J","Q"],
    ...
    ["L","B","T","L","B","Q","J","J","B","T","T","T","T","R","B","B","P","R","N","B","J","N","J","R","B","T","N","P","R","N","R","B","J","J","J","N","J","Q"],
];
...
PiecSettings.bonusSpin = 2;

// PiecSettings.bonusReelWidth = 
